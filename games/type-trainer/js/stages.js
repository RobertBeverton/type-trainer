...
const STAGE_POOL = {
  ...
  "four-letter": {
    ...
    words: [
      ...
      // from opposites word list
      "away", "bold", "calm", "cold", "cool", "dark", "dead", "deaf", "deep", "deny",
      "dull", "easy", "evil", "fail", "fair", "fall", "fill", "fine", "free", "full",
      "gain", "girl", "glad", "good", "half", "hard", "hate", "head", "heat", "hide",
      "high", "home", "keep", "lack", "late", "lead", "lean", "left", "lend", "less",
      "lose", "loud", "love", "male", "many", "miss", "move", "near", "nice", "open",
      "pain", "poor", "pull", "real", "ride", "ripe", "rise", "safe", "sane", "sell",
      "sink", "slow", "soft", "sour", "stay", "tail", "take", "tall", "tame", "true",
      "ugly", "wake", "walk", "warm", "weak", "wide", "wild", "wise",
    ],
  ...
  "five-letter": {
    ...
    words: [
      ...
      // from opposites word list
      "above", "admit", "adult", "ahead", "alive", "allow", "ample", "awake", "aware",
      "badly", "basic", "begin", "below", "black", "blind", "brave", "break", "cheap",
      "cheer", "child", "clean", "clear", "close", "curly", "early", "empty", "enjoy",
      "enter", "equal", "false", "fancy", "fewer", "first", "found", "fresh", "front",
      "green", "gross", "happy", "heavy", "inner", "large", "laugh", "least", "leave",
      "level", "light", "local", "loose", "lower", "major", "messy", "minor", "moral",
      "nasty", "never", "night", "noisy", "north", "often", "order", "outer", "peace",
      "plain", "proud", "queen", "quiet", "raise", "relax", "right", "rough", "round",
      "rural", "sadly", "salty", "sharp", "short", "shout", "sleep", "small", "smile",
      "solid", "sound", "south", "start", "steep", "sweet", "tense", "tight", "timid",
      "tired", "trust", "uncle", "union", "unite", "urban", "usual", "valid", "white",
      "whole", "woman", "worse", "worst", "wrong", "young",
    ],
